...
5. **Hosted demo + short video** — GitHub Pages build of the demo using the mock transport (the `/api/agent` server route can't run statically); the listing Discussions post encourages a demo video.
